...
fn build_stats_data_from_cache(
    ...
    Some(StatsData {
        ...
        // Cache fast-path has no per-day fidelity. The heatmap panel
        // treats an empty Vec as "no heatmap yet" and collapses to 0
        // height — hitting `r` triggers the full-scan aggregator which
        // fills this in.
